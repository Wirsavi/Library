...
/* @author Соколов Александр Александрович Дкип-401 */

public class Game extends JFrame {

    private static Game game_game;
    private static long last_frame_time;
    private static Image pyppy;
    ...
    public static void main(String[] args) throws IOException {
       pyppy = ImageIO.read(Game.class.getResourceAsStream("Pypy.png"));
       end = ImageIO.read(Game.class.getResourceAsStream("biblioteku.png"));
       liverca = ImageIO.read(Game.class.getResourceAsStream("liverca.png"));
       game_game = new Game();
    ...
    private static void onRepaint(Graphics g){
        ...
        g.drawImage(pyppy, 0, 0, null);
        g.drawImage(liverca, (int) drop_left, (int) drop_top, null);
        if(drop_top > game_game.getHeight()) g.drawImage(end, 100, 10, null);
    }
